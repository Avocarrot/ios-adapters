...
#import "AVODFPNativeViewController.h"
#import <GoogleMobileAds/GoogleMobileAds.h>

@interface AVODFPNativeViewController () <GADNativeExpressAdViewDelegate, GADVideoControllerDelegate>

@property (nonatomic, weak) IBOutlet GADNativeExpressAdView *nativeExpressAdView;

@end

@implementation AVODFPNativeViewController
